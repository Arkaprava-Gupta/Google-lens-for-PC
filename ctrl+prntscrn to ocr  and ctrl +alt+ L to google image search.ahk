...
^!l::  ; Ctrl+Alt+L
{ ; Added opening brace for multi-line hotkey
    ; Take a screenshot of a selected area
    Send("#+s")  ; Windows key + Shift + S (Changed to v2 syntax)
    
    ; Wait for the user to finish selecting the area
    KeyWait("LButton", "D")  ; Wait for left mouse button to be pressed (Changed to v2 syntax)
    KeyWait("LButton")       ; Wait for left mouse button to be released (Changed to v2 syntax)
    
    ; Wait a moment for the screenshot to be saved to clipboard
    Sleep(1000) ; (Changed to v2 syntax)
    
    ; Open Google Lens
    Run("https://lens.google.com") ; (Changed to v2 syntax)
       
    Sleep(3000) ; (Changed to v2 syntax)
    ; Paste the content from clipboard
    Send("^v") ; (Changed to v2 syntax)
} 
